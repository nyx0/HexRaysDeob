...
struct CFUnflattener : public optblock_t {
  ...
  mblock_t *GetDominatedClusterHead(mbl_array_t *mba, int iDispPred,
                                    int &iClusterHead);
  int FindBlockTargetOrLastCopy(mblock_t *mb, mblock_t *mbClusterHead,
                                mop_t *what, bool bAllowMultiSuccs);
  bool HandleTwoPreds(mblock_t *mb, mblock_t *mbClusterHead, mop_t *opCopy,
                      mblock_t *&endsWithJcc, int &actualGotoTarget,
                      int &actualJccTarget);
